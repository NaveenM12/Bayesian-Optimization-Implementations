...
parameters = [
              sherpa.sherpa1.core.Continuous('num_conv_filters', [15, 50]),
              #sherpa.Continuous('num_conv_filters', [25, 35]),
              sherpa.sherpa1.core.Continuous('num_rows_conv_kernel', [1, 7]),
              sherpa.sherpa1.core.Continuous('num_cols_conv_kernel', [1, 7]),
...
alg = sherpa.sherpa1.algorithms.BayesianOptimization(max_num_trials=100)
...
sherpa.sherpa1.core.optimize(parameters=parameters,
                ...
                filename='./trial_full.py',  # Python script to run, where the model was defined
