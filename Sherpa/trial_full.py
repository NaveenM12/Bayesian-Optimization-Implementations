...
model.add(Conv2D((int)(trial.parameters['num_conv_filters']),
                     ((int)(trial.parameters['num_rows_conv_kernel']), (int)(trial.parameters['num_cols_conv_kernel'])),
...
model.add(Convolution2D((int)(trial.parameters['num_conv_filters']),
                            ((int)(trial.parameters['num_rows_conv_kernel']), (int)(trial.parameters['num_cols_conv_kernel'])),
                            activation='relu'))
...
model.add(Flatten())
model.add(Dense((int)(trial.parameters['num_units']), activation='relu'))
...
callbacks = [client.keras_send_metrics(trial=trial, objective_name='loss')]
